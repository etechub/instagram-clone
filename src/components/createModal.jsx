    ...
    return (<>
        {show && <div className={`fixed top-0 left-0 w-full h-screen`}>
            ...
            <div className="fixed top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] z-10 text-white">
                <div className="w-[300px] md:w-[450px] px-4 bg-[#262626] text-white rounded-lg">
                    ...
                    <div className="h-[480px] flex flex-col justify-center items-center">
                        ...
                        <div className="font-bold mt-10 relative">
                            <div className="w-3 h-3 rounded-full bg-red-600 absolute -top-3 right-0"></div>
                            <label htmlFor="file" className='w-full text-center bg-blue-600 text-white rounded-lg py-3 px-5 cursor-pointer'>Choose file</label>
                            <input type="file" id="file" className='hidden' onChange={e => setSelectedFile(e.target.files[0])} />
                        </div>
                        <div className="">
                            <textarea placeholder='enter caption (optional)' className='resize-none w-[270px] md:w-[350px] mx-auto bg-transparent h-20 mt-10 rounded-lg px-4 py-1 border border-gray-600' onChange={(e) => setCaption(e.target.value)}></textarea>
                        </div>
