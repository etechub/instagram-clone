...
import { BsBookmark, BsCameraReels, BsFillBookmarkFill } from 'react-icons/bs'
            ...
            <div className='relative h-screen overflow-auto hidden md:flex flex-col lg:inline-grid gap-2 bg-black w-64 pr-1 border-r border-gray-600'>
                ...
                <div className='ml-12 flex flex-col gap-8'>
                    ...
                    <div className='text-base'>
                        <div className="flex items-center gap-3 w-fit cursor-pointer" onClick={() => setShow(true)}>
                    ...
                    <div className='flex items-center text-base gap-3'>
                        <div className='relative'>
                            <img src={img2} alt="" className='rounded-full w-8' layout="fill" objectFit="contain" />
                        </div>
                        <h1 >Profile</h1>
                    </div>
                </div>
                    ...
                    <div className="rounded-lg border border-gray-600 w-[280px] md:w-full mx-auto overflow-auto py-4 px-6 ">
                        <div className="flex gap-4">
                            <div className='flex flex-col items-center'>
                                <div className="w-[55px] h-[55px] md:w-[65px] md:h-[65px] rounded-full grid place-items-center" style={{
                                    background: 'rgb(216, 221, 19)',
                                    backgroundImage: 'linear-gradient(158deg, rgba(216, 221, 19, 1) 0%, rgba(206, 31, 208, 1) 44%, rgba(246, 157, 23, 1) 100%)'
                                }}>
                                    <img src={img2} layout="fill" objectFit="contain" alt='' className='w-[50px] h-[50px] md:w-[60px] md:h-[60px] rounded-full border-2 border-black' />
                                </div>
                    ...
                    <div className="mt-5 flex flex-col gap-6">
                        <div className="">
                            <div className="border border-gray-600 rounded-t-lg flex justify-between items-center py-3 px-4">
                                <div className="flex gap-4">
                                    <img src={img2} layout="fill" objectFit="contain" alt='' className='w-[30px] h-[30px] rounded-full' />
                                    <div className="">Dev_ahmen</div>
                                </div>
                                <FiMoreHorizontal data-te-ripple-init size={20}
                                    data-te-ripple-color="light" className='shadow-md transition duration-150 ease-in-out cursor-pointer' />
                            </div>
                            <div className="">
                                <img src={img2} layout="fill" objectFit="contain" alt='' className='w-full h-fit' />
                            </div>
                            <div className="border border-gray-600 rounded-b-lg py-4 px-4">
                                ...
                                <div className="">{truncateString('infonaija Naira Redesign: President Buhari did not ask CBN governor or Malami to defy Supreme court order - Presidency disowns Emefiele, Malami', 100)}</div>
